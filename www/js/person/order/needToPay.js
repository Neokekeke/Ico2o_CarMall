 ...
 */
angular.module('ico2o.controllers.needToPay', [])

  .controller('needToPay',function($scope,$http,$ionicLoading,locals,$timeout,proSum,orderService,$rootScope,wechatPayService){
