 ...
 */
angular.module('ico2o.controllers.sendProduct', [])

  .controller('sendProduct',function($scope,$http,$ionicLoading,locals,$timeout,proSum,$rootScope,orderService){
...
/*在我的订单中加载购物车列表*/
    ...
    $scope.proSum = [];
		...
		$http({
				...
				url: url,
				params: {
					UserID: $rootScope.UserID/*locals.get("UserID")*/,
					IsShopper: false,
					/*购物车*/
					PageNO: $scope.PageNO,
					PageSize: $scope.PageSize,
					Status: $scope.Status4
				}
			})
